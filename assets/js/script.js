...
tl1.from(".pop-img-1", 0.5, { x: "-200%", scale: 0.5 });
tl2.from(".pop-img-2", 0.5, { x: "200%", scale: 0.5 });
tl3.from(".pop-img-3", 0.5, { x: "-200%", scale: 0.5 });
tl4.from('.progress-bar', 1, { width: 0 });

const scene1 = new ScrollMagic.Scene({ triggerElement: ".intro-section-1" }).setTween(tl1).addTo(controller1);
const scene2 = new ScrollMagic.Scene({ triggerElement: ".intro-section-2" }).setTween(tl2).addTo(controller1);
const scene3 = new ScrollMagic.Scene({ triggerElement: ".intro-section-3" }).setTween(tl3).addTo(controller1);
const scene4 = new ScrollMagic.Scene({
  triggerElement: ".section-services",
  triggerHook: "onLeave",
  duration: "200%"
})
  .setPin(".section-services")
  ...
  .setTween(tl4)
  .addTo(controller2);
const scene5 = new ScrollMagic.Scene({ triggerElement: ".section-services"}).addTo(controller2)
